...
// // podemos hacerlo utilizando la sintaxis${}`. Dentro de las llaves irían todas las sentencias.
 ...
 var plantilla= `hola mi nombre ${nombre}`; 
 ...
 const titulo = '<h1>Hola a todos</h1>'
...
//Template literal / String literal
   ...
   const producto1 = "Pizza",
    ...
    // ejemplo de versiones anteriores ECMAScritp5 
 ...
 var name = "joaquin"
 var lasteName = "chable"
//  var fullName = name + lasteName;

 console.log( " mi nombre completo es : " + " " +  name + " " + lasteName) // ejemplo concatenacion
